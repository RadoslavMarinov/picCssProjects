...
#define DISABLE_PULLUPS            0x40  // for 505, 508, 509, 527 and 570 only
#define DISABLE_WAKEUP_ON_CHANGE   0x80  // for 505, 508, 509, 527 and 570 only
#define PIN_CHANGE_FROM_SLEEP      0     // DEFAULT, for 505, 508, 509, 527 and 570 only
